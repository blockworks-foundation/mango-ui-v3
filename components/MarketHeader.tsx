...
const MarketHeader = () => {
  ...
  return (
    <div
      className={`flex flex-col lg:flex-row lg:items-center lg:justify-between pt-4 px-6 lg:pb-1 lg:pt-8 lg:px-6`}
    >
      <div className="flex flex-col lg:flex-row lg:items-center">
        <div className="pb-4 lg:pb-0 pr-6">
      ...
      <div className="absolute right-4 lg:right-6 flex items-center justify-end">
        <UiLock />
