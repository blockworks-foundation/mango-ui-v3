...
export const defaultLayouts = {
  ...
  sm: [
    ...
    { i: 'tradeForm', x: 0, y: 2, w: 12, h: 16, minW: 3 },
  ...
  xs: [
    ...
    { i: 'marketPosition', x: 0, y: 1, w: 6, h: 12, minW: 2 },
    { i: 'accountInfo', x: 0, y: 2, w: 6, h: 16, minW: 2 },
    { i: 'tradeForm', x: 0, y: 3, w: 12, h: 16, minW: 3 },
