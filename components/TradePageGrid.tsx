...
export const defaultLayouts = {
  ...
  lg: [
    ...
    { i: 'orderbook', x: 0, y: 2, w: 4, h: 20, minW: 2 },
    { i: 'tradeForm', x: 4, y: 2, w: 4, h: 20, minW: 3 },
    { i: 'marketTrades', x: 8, y: 2, w: 4, h: 20, minW: 2 },
  ...
  sm: [
    ...
    { i: 'tradeForm', x: 0, y: 2, w: 12, h: 20, minW: 3 },
    { i: 'orderbook', x: 0, y: 3, w: 6, h: 20, minW: 3 },
    { i: 'marketTrades', x: 6, y: 3, w: 6, h: 20, minW: 2 },
