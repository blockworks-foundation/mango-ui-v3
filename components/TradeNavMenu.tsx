      ...
      {categories.map((cat) => {
        return (
          <button
            ...
            className={`default-transition relative flex h-14 w-full cursor-pointer flex-col justify-center whitespace-nowrap rounded-none px-4 font-bold hover:md:bg-th-bkg-3 ${
              activeCategory === cat.name
                ? `bg-th-bkg-3 text-th-primary`
                : `text-th-fgd-2 hover:md:text-th-primary`
            }
          `}
          >
...
export const FavoriteMarketButton = ({ market }) => {
  ...
  return favoriteMarkets.find((mkt) => mkt === market.name) ? (
    <button
      className="default-transition flex items-center justify-center text-th-primary hover:md:text-th-fgd-3"
    ...
    <button
      className="default-transition flex items-center justify-center text-th-fgd-4 hover:md:text-th-primary"
